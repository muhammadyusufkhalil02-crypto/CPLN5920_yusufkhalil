...
home_prices <- st_read("/Users/muhammadkhalil/Documents/Upenn /SPRING 2026/CPLN 5920/Github/CPLN5920_yusufkhalil/labs/lab_3/opa_properties_public.geojson")
st_transform(home_prices, 2272)
...
call_311_CT <- st_join(acs_data2, call_311) %>% 
  group_by(NAME) %>% 
  summarise(
    n = n()
  ) %>% 
