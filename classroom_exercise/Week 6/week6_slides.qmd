...
boston.sf <- boston.sf %>%
  mutate(
    crimes.Buffer660 = lengths(st_intersects(
...
model1<- lm(SalePrice ~ LivingArea, data = boston.sf)
summary(model1)

group_model <- lm(SalePrice ~ LivingArea + NUM_FLOORS, data = boston.sf)
summary(group_model)

group_model2 <- lm(SalePrice ~ LivingArea + NUM_FLOORS + name, data = boston.sf)
summary(group_model2)

group_model2b <- lm(SalePrice ~ LivingArea + NUM_FLOORS + Style, data = boston.sf)
summary(group_model2b)

group_model3 <- lm(SalePrice ~ LivingArea + NUM_FLOORS + crime_nn3 + dist_downtown_mi + name, data = boston.sf)
summary(group_model3)

group_model4 <- lm(SalePrice ~ LivingArea + NUM_FLOORS + crime_nn3 + dist_downtown_mi + name + Age + I(Age^2), data = boston.sf)
summary(group_model4)

group_model5 <- lm(SalePrice ~ LivingArea + NUM_FLOORS + crime_nn3 + dist_downtown_mi + name + R_BDRMS + I(R_BDRMS^2), data = boston.sf)
...
# Compare models
cv_group14 <- train(
  SalePrice ~ LivingArea + NUM_FLOORS + crime_nn3 + dist_downtown_mi + name + Age + I(Age^2),
  data = boston.sf, method = "lm", trControl = ctrl
)
cv_group14

cv_group15 <- train(
  SalePrice ~ LivingArea + NUM_FLOORS + crime_nn3 + dist_downtown_mi + name + R_BDRMS + I(R_BDRMS^2)
  data = boston.sf, method = "lm", trControl = ctrl
)

cv_group15 <- train(SalePrice ~ LivingArea + NUM_FLOORS + crime_nn3 + dist_downtown_mi + name + R_BDRMS + I(R_BDRMS^2), data = boston.sf, method = "lm", trControl = ctrl)
cv_group15
